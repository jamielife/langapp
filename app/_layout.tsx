...
import { NativeBaseProvider, Text, Icon, Pressable, Button, StatusBar, Switch, View, useColorMode, useColorModeValue, HStack, } from 'native-base';
...
// Unales use of NativeBase hooks within NB provider
function DarkModeProvider() {
	const router = useRouter();
	const { colorMode, toggleColorMode } = useColorMode();	
	const text = useColorModeValue("Light", "Dark");	
	return (
		<ThemeProvider value={useColorModeValue(DefaultTheme, DarkTheme)}>
			<Stack>
