import { HStack, Pressable, View, ZStack, Text } from 'native-base'
        ...
        <HStack mt={2} justifyContent={"space-between"} alignItems={"center"}>
            ...
            <Pressable onPress={() => seCorrectedStatus(!correctedPost) }>
                <ZStack mt={0}>
                    ...
                    <MaterialCommunityIcons name={"application-edit-outline"} size={20} color="black" />                    
                </ZStack>                                
                <Text mt={0} ml={6}>123</Text>
            </Pressable>
            ...
            <Pressable>
                <ZStack>
                    <View ml={-3} mt={-3}><Ionicons name={"people"} size={21} color={postData.isFriend ? theme.colors.cyan[500] : "rgba(255,255,255,0)"} /></View>
                    <View ml={-3} mt={-3}><Ionicons name={"people-outline"} size={21} color="black" /></View>
                </ZStack>                     
            </Pressable>
